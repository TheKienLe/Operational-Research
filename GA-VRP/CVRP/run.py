...
def load_instance(file_name):
    ...
    instance["distance_matrix"] = np.array(pd.read_excel(
                file_name, "distance").iloc[:instance['Number_of_customers']+1, 
                                            1:instance['Number_of_customers']+2])
    return instance
...
if __name__ == '__main__':
    ...
    # -> calculate cost
    # args = get_parser()
    instance = load_instance("./instance.xlsx")
    print(instance)
