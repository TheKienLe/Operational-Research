...
def get_coordinates_dframe(instance):
    ...
    x_coord_cust = [instance[f'customer_{i}']
                    ['coordinates']['x'] for i in customer_list]
    y_coord_cust = [instance[f'customer_{i}']
                    ['coordinates']['y'] for i in customer_list]
